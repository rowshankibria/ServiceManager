...
namespace LoanManager.Shared
{
    ...
    public class StringEnum
    {
        ...
        ///// <summary>
        ///// Gets the numeric value associated with the given enum value by enum type and enum string value
        ///// </summary>
        ///// <param name="enumType">Type of the enum</param>
        ///// <param name="valueName">Name of the value</param>
        ///// <returns></returns>
        //public int? GetEnumId(Type enumType, string valueName)
        //{
        ...
        //    {
        //        if (names.GetValue(i).ToString().Equals(valueName))
        //        {
        ...
        {
            if (_enumType == null) return false;
        ...
        public string GetStringValue(int value)
        {
            ...
            if (values != null)
            {
                ...
                {
                    if ((int)val == value)
                        return GetStringValue(Enum.Parse(_enumType, Enum.GetName(_enumType, (int)val)) as Enum);
                }
            }
            return "";
        }
