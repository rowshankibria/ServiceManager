...
{
    internal class GenerateEntityType
    {
        internal void GenerateEntityTypeStruct()
        {
            DBContext dbcontext = new DBContext();
            var entities = dbcontext.EntityTypes;
            ...
            entityBuilder.Append("\t");
            entityBuilder.Append($"public struct ApplicationEntityType{Environment.NewLine}");
            entityBuilder.Append("\t");
            entityBuilder.Append("{");
            entityBuilder.AppendLine();
            ...
            System.IO.StreamWriter file = new System.IO.StreamWriter(@"\ApplicationEntityType.cs");
