...
{
    public partial class LoanManage_v11Context : DbContext
    {
        public LoanManage_v11Context()
        {
        }

        public LoanManage_v11Context(DbContextOptions<LoanManage_v11Context> options)
            : base(options)
        {
        }

        public virtual DbSet<Address> Addresses { get; set; }
        public virtual DbSet<ApplicationCustomField> ApplicationCustomFields { get; set; }
        ...
        public virtual DbSet<ApplicationPageFieldDetail> ApplicationPageFieldDetails { get; set; }
        ...
        public virtual DbSet<CustomFieldControlValueOption> CustomFieldControlValueOptions { get; set; }
        public virtual DbSet<CustomFieldMaster> CustomFieldMasters { get; set; }
        public virtual DbSet<CustomFieldValidation> CustomFieldValidations { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("data source=COREI7;initial catalog=LoanManage_v1.1;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ApprovalEntityMappingChecklist>(entity =>
            {
                ...
                entity.HasOne(d => d.ApprovalProcessStepChecklist)
                    .WithMany(p => p.ApprovalEntityMappingChecklists)
                    .HasForeignKey(d => d.ApprovalProcessStepChecklistId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_ApprovalEntityMappingChecklist_ApprovalProcessStepChecklist_ApprovalProcessStepChecklist");
            ...
            modelBuilder.Entity<Configuration>(entity =>
            {
                ...
                entity.HasOne(d => d.IdNavigation)
                    ...
                    .HasForeignKey<Configuration>(d => d.Id)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<EmailHistory>(entity =>
            {
                ...
                entity.Property(e => e.EmailReceiver).HasMaxLength(500);
