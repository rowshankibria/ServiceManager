...
import { DxDataGridComponent, DxDataGridModule, DxSelectBoxModule, DxCheckBoxModule, DxButtonModule, DxValidatorModule } from 'devextreme-angular';
...
export class PasswordSettingComponent implements AfterViewInit {
