...
export class NoteComponent implements AfterViewChecked {
    ...
    init(): void {
        ...
        this.loanService.getApplicationUserNoteList(this.applicationId).subscribe(data => {
            ...
            this.applicationNoteList = data.result.noteList,
                ...
                this.titlebar.initializeToolbar("User Note", null, this.toolbarType, this.disableItem);
        });
    ...
    saveEntity(action: DetailPageAction): void {
        ...
        this.loanService.updateUserNoteList(this.applicationNoteList).subscribe(data => {
