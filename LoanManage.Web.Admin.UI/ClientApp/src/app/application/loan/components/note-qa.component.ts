...
export class NoteQAComponent implements AfterViewChecked {
    ...
    init(): void {
        ...
        this.loanService.getApplicationQANoteList(this.applicationId).subscribe(data => {
    ...
    saveEntity(action: DetailPageAction): void {
        ...
        this.loanService.updateQANoteList(this.applicationNoteList).subscribe(data => {
